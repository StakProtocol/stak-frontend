...
interface ICOUnlockModalProps {
  isOpen: boolean;
  onClose: () => void;
  icoAddress: Address;
  positionId: string;
  maxTokens: number; // total position tokens (vesting amount)
  assetDecimals: string;
  assetSymbol: string;
}

export function ICOUnlockModal({
  isOpen,
  onClose,
  icoAddress,
  positionId,
      ...
      <div className="bg-white dark:bg-dark-primary rounded-xl p-6 max-w-md w-full mx-4 shadow-xl" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
          <div className="flex justify-between text-sm">
            <span className="text-gray-600 dark:text-gray-400">Total Position Tokens:</span>
