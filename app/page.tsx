          ...
          <Link href="/vaults">
            <div className="group relative bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200 dark:border-gray-700 hover:border-purple-500 dark:hover:border-primary">
              ...
              <div className="relative">
                ...
                <div className="flex items-center text-purple-600 dark:text-primary font-medium">
                  Explore Vaults
