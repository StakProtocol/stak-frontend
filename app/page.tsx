        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <Link href="/vaults">
            <div className="group relative bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200 dark:border-gray-700 hover:border-purple-500 dark:hover:border-primary">
              ...
              <div className="relative">
                <div className="w-16 h-16 p-3 bg-[#19a5ba] rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                  <svg version="1.1" id="VAULT" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1800 1800" enable-background="new 0 0 1800 1800" fill="#ffffff" stroke="#ffffff">
                ...
                <div className="flex items-center text-purple-600 dark:text-[#19a5ba] font-medium">
                  Explore Vaults
                  <svg className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
